...
This is an exploit chain for Fire HD 8 (2018) (8th gen / karnak / KFKAWI). It contains a MediaTek bootrom exploit, a Preloader exploit and a LittleKernel bootloader exploit.
...
`lk-payload`, `pl-payload`, `modules` and `microloader` are licensed under MIT.
