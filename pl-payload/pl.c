...
#define PRELOADER_BASE 0x12001000

uint16_t send_dword_pattern[]  = {0xB507, 0x0E03};
uint16_t recv_dword_pattern[]  = {0x4B0D, 0x2200};
uint16_t msdc_init_pattern[] = {0x2801, 0xB570, 0x4604};
...
int main() {
    ...
    printf("Ported to mt8135 by R0rt1z2\n");
    ...
    void (*msdc_init)(int id, uint32_t trans_mode) = (void *)(searchfunc(PRELOADER_BASE + 0x100, PRELOADER_BASE + 0x20000, msdc_init_pattern, 3) | 1);
    printf("msdc_init = %p\n", msdc_init);
    msdc_init(0, MSDC_MODE_DMA_BASIC);
